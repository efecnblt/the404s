            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    AppLocalizations.of(context)?.slogan ?? "Artificial intelligence supported education application!",
                    textAlign: TextAlign.center,
                    style: TextStyle(
                  ...
                  Container(
                    margin: const EdgeInsets.only(left: 25, right: 25, top: 15, bottom: 40),
                    width: 350,
                    child: PasswordField(
                      fieldBackgroundColor: Colors.white,
                      shadowColor: Colors.black,
                  ...
                  GestureDetector(
                    child: Opacity(
                      opacity: 0.50,
                      child: Text(
                        AppLocalizations.of(context)?.troubleLoggingIn ?? "Having trouble logging in?",
